...
- **分析**：checkpoint 越少越能减少刷盘等同步开销，从而在正常运行时释放更多 IO/CPU 资源提高平均吞吐量，而恢复时需处理的日志量更大又会集中触发大量写入，从而造成更高的吞吐量峰值。
...
在30秒间隔下，系统延迟波动最小，同时Checkpoint Duration波动虽然不及5min间隔稳定，但是要远远优于5s间隔的波动，处于比较可控的范围：
