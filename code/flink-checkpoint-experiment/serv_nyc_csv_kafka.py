...
def serve_csv_lines(csv_file_path, kafka_bootstrap="localhost:9092", topic="nyc-taxi-raw", timerate=7200):
    """
    ...
    try:
        ...
        print(f"✅ 自动创建 Kafka Topic: {topic} (8 分区)")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--timerate", type=int, default=7200, help="时间倍率（现实 1 秒 = 数据中 N 秒，默认 7200）")
